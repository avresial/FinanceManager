    ...
    public static class ServiceCollectionExtension
    {
        ...
        public static IServiceCollection AddInfrastructureApi(this IServiceCollection services)
        {
            services.AddSingleton<ActiveUsersContext>()
                    .AddSingleton<UsersContext>()
                    .AddSingleton<StockPricesContext>()
                    .AddSingleton<BankAccountContext>()
                    .AddSingleton<BankAccountEntryContext>()
                    .AddSingleton<StockAccountContext>()
                    .AddSingleton<StockAccountEntryContext>()
                    .AddSingleton<IStockRepository, StockRepositoryMock>()
