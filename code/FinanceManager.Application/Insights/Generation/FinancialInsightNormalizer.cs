...
{
    public List<FinancialInsight> Normalize(IReadOnlyList<InsightItem> items, int userId, int? accountId, int count)
    {
        var now = DateTime.UtcNow;
        var result = new List<FinancialInsight>(Math.Min(count, items.Count));
