...
// Update strategy (decided on #554): no skipWaiting/clients.claim — a newly deployed
// service worker waits until every tab running the old version is closed, then takes
// over silently on the next page load.
...
async function onFetch(event) {
    ...
    if (event.request.method === 'GET') {
        ...
        // unless that request is for an offline resource or a server-rendered
        // endpoint (API routes, SignalR hubs).
