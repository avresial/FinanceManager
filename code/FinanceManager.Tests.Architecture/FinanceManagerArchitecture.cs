...
public static class FinanceManagerArchitecture
{
    ...
    private static readonly System.Reflection.Assembly _componentsAssembly = typeof(FinanceManager.Components.Features.Administration.HttpClients.AdminAiProvidersHttpClient).Assembly;
